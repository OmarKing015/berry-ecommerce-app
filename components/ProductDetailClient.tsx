            ...
            <div className="space-y-4">
                ...
                {totalImages > 1 && (
                  <>
                    <Button
                      variant="outline"
                      size="icon"
                      className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white shadow-lg group-hover:opacity-100 transition-all duration-200 z-10"
                    ...
                    <Button
                      variant="outline"
                      size="icon"
                      className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white shadow-lg group-hover:opacity-100 transition-all duration-200 z-10"
              ...
              <div className="grid grid-cols-4 md:grid-cols-5 gap-2">
                {product.images?.map((image, index) => (
                  <div
                    key={index}
                    className={`relative aspect-square w-40 h-40  rounded-md overflow-hidden cursor-pointer transition-all duration-200 ${selectedImage === index
