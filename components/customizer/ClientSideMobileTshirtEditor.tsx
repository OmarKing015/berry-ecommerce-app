...
const MobileTshirtEditor = dynamic(() => import("@/components/customizer/MobileTshirtEditor"), {
  ssr: false,
  loading: () => (
...
export default function ClientSideMobileTshirtEditor() {
  return <MobileTshirtEditor />
}
